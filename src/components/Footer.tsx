...
const FOOTER_LINKS: Record<string, { label: string; href: string }[]> = {
  Product:   [
    { label: 'Crop Diagnosis',  href: '/product' },
    { label: 'How It Works',    href: '/how-it-works' },
    { label: 'Technology',      href: '/technology' },
    { label: 'Supported Crops', href: '/product' },
    { label: 'Roadmap',         href: '/technology' },
  ],
  Solutions: [
    { label: 'Farmers',           href: '/solutions' },
    { label: 'Cooperatives',      href: '/solutions' },
    { label: 'NGOs',              href: '/solutions' },
    { label: 'Extension Services',href: '/solutions' },
    { label: 'Agribusinesses',    href: '/solutions' },
  ],
  Company: [
  ...
  Resources: [
    { label: 'Agriculture Insights', href: '/technology' },
    { label: 'Crop Health',          href: '/product' },
...
const TwitterIcon = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L2 2.25h6.828l4.27 5.655 5.146-5.655zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>;
        ...
        <div className="footer__top">
          <div className="footer__brand">
            ...
            <div className="footer__social" aria-label="Social media links">
              ...
              <a href="#" aria-label="LinkedIn"     className="footer__social-link"><LinkedinIcon /></a>
              <a href="#" aria-label="GitHub"       className="footer__social-link"><GithubIcon /></a>
            </div>
          </div>
